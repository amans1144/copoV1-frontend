...
const URL = 'mongodb+srv://revacopov1:Reva123456@@cluster0.mi2gv.mongodb.net/Revacopo?retryWrites=true&w=majority'
...
const PORT = process.env.PORT || '9000'; //2 - get the port from env file, if not available pick 8080
